                ...
                hotspots: [
                    ...
                    },
                    {
                        ...
                        facts: [
                            "🍃 叶片由叶片主体、叶柄和叶脉组成",
                            "🚰 叶脉像小管道，负责输送水分和营养",
                            "☀️ 叶子能进行光合作用：吸收阳光，把二氧化碳和水变成养分和氧气",
                            "💨 叶子还会蒸腾作用：排出多余水分，帮助植物降温",
                            "🍂 秋天叶子会变黄、掉落，最后腐烂成为泥土",
                            "🌞 植物会朝着阳光生长，这叫向光性"
                        ],
                        grades: {
                    ...
                    },
                    {
                        ...
                        x: 75, y: 35,
                        facts: [
                            "🛡️ 萼片：花苞外层的小绿片，保护还没开放的花朵",
                            "🌈 花瓣：颜色鲜艳，吸引蜜蜂蝴蝶来帮忙",
                            "🌾 雄蕊：产生花粉，花粉落到雌蕊上才能完成授粉",
                            "🥚 雌蕊：底部有子房，受精后会慢慢发育成果实",
                            "🔄 自花传粉：同一朵花里完成授粉",
                            "🐝 异花传粉：靠昆虫或风把花粉带到另一朵花上",
                            "⚠️ 只有完成受精，花朵才能长出果实和种子"
                        ],
                        grades: {
                            low: "花有美丽的颜色，吸引昆虫",
                            mid: "认识花四大部分，了解传粉方式",
                    ...
                    },
                    {
                        ...
                        facts: [
                            "🛡️ 果实像小房子，保护里面的种子",
                            "🍽️ 果实还能为种子成长提供营养",
                            "💥 弹力传播：果实成熟后会炸开，把种子弹出去，比如凤仙花、油菜",
                            "🐿️ 动物传播：苍耳会粘在动物皮毛上，果肉被吃掉后种子随粪便排出",
                            "🌬️ 风力传播：蒲公英种子像小伞，随风飘到远方",
                            "🌊 水力传播：莲蓬、椰子能漂在水上，随水流到新的地方"
                        ],
                        grades: {
                            low: "果实里面有种子",
                            mid: "认识四种种子传播方式",
    ...
    human: {
        ...
        sections: {
            ...
            "respiratory": {
                name: "呼吸系统",
                icon: "🫁",
                intro: "呼吸系统获取氧气（O₂），排出体内二氧化碳（CO₂）",
                organs: [
                    { name: "鼻咽喉", icon: "👃", function: "气体进出通道，温润、清洁空气" },
                    { name: "气管", icon: "📯", function: "输送空气到肺部，有纤毛清除灰尘" },
                    { name: "支气管", icon: "🌳", function: "分左右两支进入肺部" },
                    { name: "肺部", icon: "🎈", function: "气体交换核心器官，肺泡完成氧气（O₂）和二氧化碳（CO₂）交换" }
                ],
                process: "吸气：外界空气（含氧气 O₂）→ 鼻 → 咽喉 → 气管 → 支气管 → 肺（氧气进入血液）",
                exhale: "呼气：体内二氧化碳（CO₂）→ 肺 → 支气管 → 气管 → 咽喉 → 鼻 → 外界"
            },
            "circulatory": {
                name: "循环系统",
                icon: "❤️",
            ...
            "chemical-changes": {
                ...
                examples: [
                    ...
                    { name: "呼吸作用", icon: "💨", desc: "氧气（O₂）和有机物反应，产生二氧化碳（CO₂）和水，释放能量" },
                    { name: "身体生长", icon: "📈", desc: "细胞分裂合成新物质" },
                    { name: "伤口愈合", icon: "🩹", desc: "血小板凝固，白细胞杀菌，新细胞生成" }
                ],
                energy: "呼吸作用：氧气（O₂）+ 有机物 → 二氧化碳（CO₂）+ 水 + 能量（供人体运动、生长）"
            }
        }
    },
    ...
    experiments: {
        ...
        labs: [
            ...
            },
            {
                ...
                formula: "二氧化碳（CO₂）+ 水 → 氧气（O₂）+ 养料（需要阳光和叶绿体）"
            }
        ]
    },
